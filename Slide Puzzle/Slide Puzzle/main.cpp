...
int main ()
{
	...
	if (!file_exists(ReadMeTxt))
	{
		...
		if (err != 0)
		{
			al_show_native_message_box(NULL, "Critical Error", "Ups! What have you done?", "Could not find necessary data files.\nPlease delete \"puzzle_data\" folder completely and restart the program.", NULL, ALLEGRO_MESSAGEBOX_WARN);
			cout << endl << endl;
			cout << "..:: An error has occured, please delete puzzle_data folder ::.." << endl;
